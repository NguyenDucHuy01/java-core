...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 23, 2019 lúc 01:29 PM
...
--
-- Cấu trúc bảng cho bảng `chitietphieumoun`
--

CREATE TABLE `chitietphieumoun` (
...
--
-- Đang đổ dữ liệu cho bảng `chitietphieumoun`
--

INSERT INTO `chitietphieumoun` (`mactpm`, `mas`, `magiaodich`) VALUES
(1, 2, 1),
(6, 3, 3),
(7, 1, 4),
(8, 4, 4),
...
CREATE TABLE `login` (
  `usename` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `login` (`usename`, `password`, `quyen`) VALUES
('admin', '123456', 1),
('heart', '123456', 0),
('noname', '123456', 0);
...
INSERT INTO `muontra` (`magiaodich`, `ngaymuon`, `ngaytra`, `matv`, `soluong`, `xoa`) VALUES
(1, '2018-04-18', '2019-01-09', 2, 2, 1),
(2, '2019-01-09', '2019-01-21', 9, 2, 0),
(3, '2019-01-20', '2019-01-31', 3, 3, 0),
(4, '2019-01-20', '2019-01-17', 4, 3, 0),
(5, '2019-01-20', '2019-02-20', 1, 3, 1),
(6, '2019-01-20', '2019-02-20', 4, 3, 0),
(7, '2019-01-20', '2019-02-20', 1, 3, 1),
(8, '2019-01-20', '2019-02-20', 1, 3, 0),
(9, '2019-01-20', '2018-12-20', 1, 3, 1),
(10, '2019-01-20', '2019-02-20', 2, 3, 1),
(11, '2019-01-20', '2019-02-20', 2, 3, 0),
(12, '2019-01-20', '2019-02-20', 1, 3, 1),
(13, '2019-01-20', '2019-02-20', 2, 3, 0);
...
CREATE TABLE `sach` (
  `mas` int(10) NOT NULL,
  `tens` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `matg` int(10) NOT NULL,
  `manxb` int(10) NOT NULL,
  `namxb` date NOT NULL,
  `matls` int(10) NOT NULL,
  `soluong` int(11) NOT NULL,
  `xoa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `sach` (`mas`, `tens`, `matg`, `manxb`, `namxb`, `matls`, `soluong`, `xoa`) VALUES
(1, 'từ ấy', 1, 1, '0000-00-00', 1, 3, 1),
(2, 'Muộn Màng', 2, 1, '0000-00-00', 2, 9, 1),
(3, 'lemon', 3, 1, '2001-11-21', 1, 7, 1),
(4, 'Haha', 1, 2, '2019-01-06', 1, 12, 0),
(5, 'Vội Vàng', 3, 2, '2007-01-31', 1, 1, 1),
(6, 'hhhhhh', 1, 1, '2019-01-20', 1, 2, 1),
(7, 'Truyện Kiều', 2, 2, '2004-03-25', 1, 1, 1),
(8, 'su', 3, 2, '2019-01-01', 2, 2, 1),
(9, 'fgfgfgfgfg', 1, 1, '2019-01-20', 1, 3, 1),
(10, 'min', 3, 2, '2019-01-10', 1, 4, 1),
(11, 'FFFFFF', 1, 1, '2019-01-23', 1, 2, 1),
(12, 'fsgs', 1, 1, '2019-01-23', 1, 4, 1);
...
CREATE TABLE `thanhvien` (
  ...
  `maph` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `thanhvien` (`matv`, `tentv`, `diachi`, `maph`, `sodt`, `email`, `xoa`) VALUES
(1, 'Autumn Heart', '56 Nguyễn Văn sĩ', '00001', '0396378567', 'autumnheart0802@gmail.com', 1),
(2, 'Heart Autumn', '22 lê lợi', '00022', '0396378567', 'heartautumn0308@gmail.com', 0),
(3, 'Nguyễn Đức Huy', 'Quảng Trị', '00004', '0396378567', 'heart0803@gmail.com', 1),
(4, 'Hoàng Huy', 'paster', '00007', '0183756583', 'hoanghuy@gmail.com', 0),
(5, 'HEART ', 'HUENDHD HSDFUANF ', '00007', '9847659375', 'HEART@GMAIL.COM', 0),
(6, 'HAJFK A', 'AKSDFNKA', '00007', '080796965', 'ASDJ,J,FNKAJHSD', 0),
(7, 'huenrm rqkrektwa1', 'rưertwerfga1', '00007', '888888', 'jashdfasndklqw1', 0),
(8, 'jeal ákdk', 'dfa fasdf', '00008', '4246566', 'sdfmas dnasd', 0),
(9, 'heug', 'jdfk jansdjfs', '00008', '4356773', 'jahsjd fa ádf', 1),
(10, 'maill fill', 'henk nien', '00142', '3567367', 'asdfjnkjjdf kasdfk', 1),
(11, 'minnn', 'fav avad', '00832', '235635675', 'hunuanshja', 1);
...
CREATE TABLE `theloaisach` (
  `matls` int(10) NOT NULL,
  `tentls` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `theloaisach` (`matls`, `tentls`) VALUES
(1, 'thơ'),
(2, 'Love Story'),
(3, 'tiểu Thuyết'),
(4, 'trinh thám'),
...
CREATE TABLE `xaphuong` (
  `maph` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL,
  `type` varchar(30) CHARACTER SET utf8 NOT NULL,
  `maqh` varchar(5) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `xaphuong` (`maph`, `name`, `type`, `maqh`) VALUES
...
--
-- Chỉ mục cho bảng `chitietphieumoun`
--
ALTER TABLE `chitietphieumoun`
...
--
-- AUTO_INCREMENT cho bảng `chitietphieumoun`
--
ALTER TABLE `chitietphieumoun`
  MODIFY `mactpm` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT cho bảng `muontra`
--
ALTER TABLE `muontra`
  MODIFY `magiaodich` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `sach`
  MODIFY `mas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `tacgia`
--
ALTER TABLE `tacgia`
  MODIFY `matg` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `thanhvien`
--
ALTER TABLE `thanhvien`
  MODIFY `matv` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `theloaisach`
--
ALTER TABLE `theloaisach`
  MODIFY `matls` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Các ràng buộc cho bảng `chitietphieumoun`
--
ALTER TABLE `chitietphieumoun`
  ADD CONSTRAINT `chitietphieumoun_ibfk_2` FOREIGN KEY (`magiaodich`) REFERENCES `muontra` (`magiaodich`),
  ADD CONSTRAINT `chitietphieumoun_ibfk_3` FOREIGN KEY (`mas`) REFERENCES `sach` (`mas`);

--
-- Các ràng buộc cho bảng `muontra`
--
ALTER TABLE `muontra`
  ADD CONSTRAINT `muontra_ibfk_1` FOREIGN KEY (`matv`) REFERENCES `thanhvien` (`matv`);
...
--
ALTER TABLE `sach`
  ADD CONSTRAINT `sach_ibfk_1` FOREIGN KEY (`manxb`) REFERENCES `nhaxb` (`manxb`),
  ADD CONSTRAINT `sach_ibfk_2` FOREIGN KEY (`matg`) REFERENCES `tacgia` (`matg`),
  ADD CONSTRAINT `sach_ibfk_3` FOREIGN KEY (`matls`) REFERENCES `theloaisach` (`matls`);

--
-- Các ràng buộc cho bảng `thanhvien`
--
ALTER TABLE `thanhvien`
  ADD CONSTRAINT `thanhvien_ibfk_1` FOREIGN KEY (`maph`) REFERENCES `xaphuong` (`maph`);

--
-- Các ràng buộc cho bảng `xaphuong`
--
ALTER TABLE `xaphuong`
  ADD CONSTRAINT `xaphuong_ibfk_1` FOREIGN KEY (`maqh`) REFERENCES `quanhuyen` (`maqh`);
COMMIT;
